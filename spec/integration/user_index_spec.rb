...
RSpec.describe 'User Page Index', type: :feature do
  before :each do
    ...
    @lilly = User.create(name: 'Lilly', photo: 'https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80', bio: 'Teacher', posts_counter: 0)
    visit root_path
  end
  ...
  it 'shows the photo of each user' do
    ...
    assert page.has_xpath?("//img[@src = 'https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80' and @alt = 'user photo']")
  end
